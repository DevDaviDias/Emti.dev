...
export default function JavaPooPage({ onNavigate }: JavaPooPageProps) {
  const aulas: Aula[] = [
    ...
    { n: 6, t: "Compilação e execução", d: "O fluxo do código fonte ao Bytecode.", s: "concluido", id: "java-aula-6" },
    { n: 7, t: "Variáveis e Tipos de Dados", d: "Armazenamento de dados e tipos primitivos.", s: "concluido", id: "java-aula-7" },
